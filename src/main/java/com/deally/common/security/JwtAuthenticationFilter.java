...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String attemptTokenRefresh(
        ...
        try {
            ...
            var refreshRequest = new com.deally.core.auth.dto.RefreshTokenRequest(refreshToken);

            var context = WebApplicationContextUtils.getRequiredWebApplicationContext(request.getServletContext());

            var authService = context.getBean(com.deally.core.auth.AuthService.class);
