package com.deally.core.auth;

import com.deally.common.exception.UnauthorizedException;
import com.deally.common.security.JwtTokenProvider;
import com.deally.common.security.SecurityUser;
import com.deally.common.security.TokenRedisService;
import com.deally.core.auth.dto.LoginRequest;
import com.deally.core.auth.dto.LoginResponse;
import com.deally.core.auth.dto.RefreshTokenRequest;
import com.deally.user.domain.model.Email;
import com.deally.user.domain.model.Password;
...
public class AuthService {
    ...
    public LoginResponse refreshToken(RefreshTokenRequest request) {
        ...
        User user = userRepository.findById(com.deally.user.domain.model.UserId.of(userId))
