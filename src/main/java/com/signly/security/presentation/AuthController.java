...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<com.signly.common.response.ApiResponse<LoginResponse>> login(@Valid @RequestBody LoginRequest request) {
        LoginResponse response = authenticationService.login(request);
        return ResponseEntity.ok(com.signly.common.response.ApiResponse.success(response));
    }
    ...
    @PostMapping("/refresh")
    public ResponseEntity<com.signly.common.response.ApiResponse<TokenResponse>> refreshToken(@Valid @RequestBody RefreshTokenRequest request) {
    ...
    @PostMapping("/logout")
    public ResponseEntity<com.signly.common.response.ApiResponse<Void>> logout(@RequestHeader("Authorization") String authorization) {
        String token = authorization.substring("Bearer ".length());
        authenticationService.logout(token);
        return ResponseEntity.ok(com.signly.common.response.ApiResponse.success());
    }
}