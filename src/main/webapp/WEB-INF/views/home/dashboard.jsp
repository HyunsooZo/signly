            ...
            <body>
                ...
                <div class="container mt-4">
                    <div class="main-content-card">
                        ...
                        <!-- 프로필 완성 알림 -->
                        <div id="profileCompletionAlert" class="alert alert-info alert-dismissible fade show"
                                ...
                                <div class="stats-card bg-primary">
                                    <div class="stats-content">
                                        ...
                                        <div class="stats-info">
                                            <h3>
                                                <c:out value="${templateStats.total}" />
                                            </h3>
                                            <p>총 템플릿</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3 mb-3">
                                <div class="stats-card bg-success">
                                    <div class="stats-content">
                                        ...
                                        <div class="stats-info">
                                            <h3>
                                                <c:out value="${templateStats.active}" />
                                            </h3>
                                            <p>활성 템플릿</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3 mb-3">
                                <div class="stats-card bg-info">
                                    <div class="stats-content">
                                        ...
                                        <div class="stats-info">
                                            <h3>
                                                <c:out value="${contractStats.total}" />
                                            </h3>
                                            <p>총 계약서</p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-lg-3 mb-3">
                                <div class="stats-card bg-warning">
                                    <div class="stats-content">
                                        ...
                                        <div class="stats-info">
                                            <h3>
                                                <c:out value="${contractStats.pending}" />
                                            </h3>
                                            <p>서명 대기</p>
                                        </div>
                                    </div>
                                        ...
                                        <c:choose>
                                            <c:when test="${empty recentTemplates}">
                                                <div class="text-center py-4">
                                                    ...
                                                    <a href="/templates/new" class="btn btn-primary btn-sm">첫 번째 템플릿
                                                        생성</a>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
                                        ...
                                        <c:choose>
                                            <c:when test="${empty recentContracts}">
                                                <div class="text-center py-4">
                                                    ...
                                                    <a href="/contracts/new" class="btn btn-primary btn-sm">첫 번째 계약서
                                                        생성</a>
                                                </div>
                                            </c:when>
                                            <c:otherwise>
