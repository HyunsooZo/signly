                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="card-title mb-0">
                                                <i class="bi bi-building me-2"></i>회사 정보 설정
                                            </h5>
                                        </div>
                                        <div class="card-body">
                                            <form action="/profile/update" method="post" class="row g-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<c:out value='${currentUser.email}'/>" disabled readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label text-muted">이름</label>
                                                    <input type="text" class="form-control"
                                                        value="<c:out value='${currentUser.name}'/>" disabled readonly>
                                                    <input type="hidden" name="name"
                                                        value="<c:out value='${currentUser.name}'/>">
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="companyName"
                                                        name="companyName"
                                                        value="<c:out value='${currentUserCompany.businessName}'/>"
                                                        placeholder="(주)예시회사">
                                                </div>
                                                <div class="col-md-6">
                                                    <label for="businessPhone" class="form-label">사업자 연락처</label>
                                                    <input type="text" class="form-control" id="businessPhone"
                                                        name="businessPhone"
                                                        value="<c:out value='${currentUserCompany.businessPhone}'/>"
                                                        placeholder="02-1234-5678">
                                                </div>

                                                <div class="col-md-6">
                                                    <label for="businessAddress" class="form-label">사업자 주소</label>
                                                    <input type="text" class="form-control" id="businessAddress"
                                                        name="businessAddress"
                                                        value="<c:out value='${currentUserCompany.businessAddress}'/>"
                                            ...
                                            <c:choose>
                                                <c:when test="${hasSignature}">
                                                    ...
                                                    <div class="mt-3 text-muted small">
                                                        <div><strong>업로드일:</strong>
                                                            <fmt:formatDate value="${signature.updatedAtDate}"
                                        ...
                                        <div class="card-body">
                                            <form method="post" id="signatureForm" class="d-flex flex-column h-100">
                                                ...
                                                <div class="d-flex gap-2 mt-auto">
                                                    ...
                                                    <button type="submit" id="realSubmitButton"
                    ...
                    <c:choose>
                        <c:when test="${hasSignature}">
                            <script type="application/json"
                                id="ownerSignatureDataJson">{"dataUrl":"${fn:escapeXml(signatureDataUrl)}","updatedAt":"${ownerSignatureUpdatedAt}"}</script>
                        </c:when>
                        <c:otherwise>
