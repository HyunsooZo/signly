...
<body>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            <button type="button"
                                                                    ...
                                                                    data-template-title="<c:out value='${template.title}'/>"
                                                                    data-template-content="<c:out value='${template.content}'/>"
    ...
    <script>
        ...
        function previewTemplateModal(templateId, title, encodedContent) {
            ...
            const previewContent = buildPreviewContent(rawContent, title);
