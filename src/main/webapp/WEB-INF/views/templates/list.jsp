                                                        ...
                                                        <div class="template-preview preset-document"
                                                            ...
                                                            <c:choose>
                                                                <c:when test="${not empty template.renderedHtml}">
                                                                    <c:out value="${template.renderedHtml}"
                                                                        escapeXml="false" />
                                                                </c:when>
                                                                <c:otherwise>
                                                        ...
                                                        <div class="template-footer mt-auto">
                                                            <div class="template-meta-info mb-2">
                                                                <small class="text-muted d-block mb-1">
                                                                    ...
                                                                    등록일:
                                                                    <fmt:formatDate value="${template.createdAtDate}"
                                                                        pattern="yyyy-MM-dd" />
                                                                </small>
                                                            ...
                                                            <div
                                                                class="template-actions d-flex gap-1 justify-content-center">
                                                                <button type="button"
                                                                    ...
                                                                    onclick="previewTemplateButton(this)" title="미리보기">
                                                                    <i class="bi bi-eye"></i>
                                                                </button>
