...
-- Signature 관련 추가 인덱스
CREATE INDEX IF NOT EXISTS idx_signature_contract_signer ON contract_signatures(contract_id, signer_email);
CREATE INDEX IF NOT EXISTS idx_signature_contract_signed ON contract_signatures(contract_id, signed_at);
